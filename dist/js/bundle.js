...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _models_Card__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/Card */ \"./src/js/models/Card.js\");\n/* harmony import */ var _views_base__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./views/base */ \"./src/js/views/base.js\");\n/* harmony import */ var _views_cardView__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./views/cardView */ \"./src/js/views/cardView.js\");\n\n\n\nvar middlePile = [];\nvar strength, skill, size, button, attr, HTMLs, player1, player2, gamePlaying, attributes;\n\nfunction setAtr(atr) {\n  var htmlAtr = \"<p id=\\\"\".concat(atr, \"\\\">\").concat(atr.charAt(0).toUpperCase() + atr.slice(1), \":</p><p class=\\\"\").concat(atr, \"-value\\\">%\").concat(atr, \"%</p>\");\n  return htmlAtr;\n}\n\n;\nplayer1 = {\n  containerId: 'card-player1',\n  cards: []\n};\nplayer2 = {\n  containerId: 'card-player2',\n  cards: []\n};\nattributes = {\n  attr1: 0,\n  attr2: 0\n};\nvar allCards = [new _models_Card__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"Iron Man\", 30, 9, 10, 5, 20, 10, \"./img/ironMan.png\"), new _models_Card__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"Dr. Strange\", 15, 7, 8, 2, 80, 8, \"./img/drStrange.png\"), new _models_Card__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"Captain America\", 28, 10, 10, 2, 25, 9, \"./img/captainAmerica.png\"), new _models_Card__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"Ant-Man\", 10, 10, 1, 1, 25, 7, \"./img/antMan.png\"), new _models_Card__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"Hulk\", 50, 2, 5, 1, 20, 9, \"./img/hulk.png\"), new _models_Card__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"Thor\", 30, 3, 11, 1, 75, 9, \"./img/thor.png\")]; // init();\n// GAME CONTROLLER\n// 1. Shuffle cards function\n\nfunction shuffle(a) {\n  for (var i = a.length - 1; i > 0; i--) {\n    var j = Math.floor(Math.random() * (i + 1));\n    var _ref = [a[j], a[i]];\n    a[i] = _ref[0];\n    a[j] = _ref[1];\n  }\n\n  return a;\n} //  2. Deal cards function\n\n\nfunction dealCards(arr, player1, player2) {\n  var cards1, cards2;\n  shuffle(arr);\n  cards1 = player1.cards;\n  cards2 = player2.cards;\n  var half = arr.length / 2;\n\n  for (var i = 0; i < half; i++) {\n    cards1.push(arr[i]);\n  }\n\n  for (var _i = half; _i < arr.length; _i++) {\n    cards2.push(arr[_i]);\n  }\n}\n\nfunction showCards(player) {\n  document.getElementById(_views_base__WEBPACK_IMPORTED_MODULE_1__[\"elements\"].content).innerHTML = _views_cardView__WEBPACK_IMPORTED_MODULE_2__[\"showCard\"](player);\n}\n\nfunction cleanField(a) {\n  document.getElementById(a).innerHTML = \"\";\n}\n\ndocument.getElementById(_views_base__WEBPACK_IMPORTED_MODULE_1__[\"elements\"].newGame).addEventListener('click', init);\n\nfunction init() {\n  // 1. Shuffle Cards\n  player1.cards = [];\n  player2.cards = []; // 1a. Clean main page\n\n  cleanField(_views_base__WEBPACK_IMPORTED_MODULE_1__[\"elements\"].content); // 2. Deal Cards\n\n  dealCards(allCards, player1, player2);\n  showCards(player1);\n  showCards(player2);\n  console.log(allCards);\n  console.log(player1.cards);\n  console.log(player2.cards);\n  attributes.attr1 = 0;\n  attributes.attr2 = 0;\n  gamePlaying = true;\n}\n\n//# sourceURL=webpack:///./src/js/index.js?");

/***/ }),

/***/ "./src/js/models/Card.js":
/*!*******************************!*\
  !*** ./src/js/models/Card.js ***!
  \*******************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Card; });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Card = function Card(title, strength, skill, size, wisecracks, mystique, rating, image) {\n  _classCallCheck(this, Card);\n\n  this.title = title;\n  this.strength = strength;\n  this.skill = skill;\n  this.size = size;\n  this.wisecracks = wisecracks;\n  this.mystique = mystique;\n  this.rating = rating;\n  this.image = image;\n};\n\n\n;\n\n//# sourceURL=webpack:///./src/js/models/Card.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"elements\", function() { return elements; });\nvar elements = {\n  cardTitle: '.card-title',\n  cardImg: 'card-image',\n  cardStr: '.card-strength',\n  cardSkill: '.card-skill',\n  cardSize: '.card-size',\n  cardWise: '.card-wisecracks',\n  cardMyst: '.card-mystique',\n  cardRate: '.card-rating',\n  strBtn: '.strength-button',\n  skillBtn: '.skill-button',\n  sizeBtn: '.size-button',\n  wiseBtn: '.wisecracks-button',\n  mystBtn: '.mystique-button',\n  rateBtn: '.rating-button',\n  contBtn: 'continue-btn',\n  newGame: 'play-btn',\n  content: 'content'\n};\n\n//# sourceURL=webpack:///./src/js/views/base.js?");
